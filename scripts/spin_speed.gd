...
@onready var spin_label: Label = $"MarginContainer/VBoxContainer/Spin Label"
@onready var spin_button: Button = $"MarginContainer/VBoxContainer/Spin Button"
...
func _on_spin_pressed() -> void:
	...
	GameSession.session_result.spin_speed = 1.0
	spin_label.text = "Speed: %.2f" % 1.0
	spin_button.hide()
	next_button.show()
